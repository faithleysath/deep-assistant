...
def chat():
    ...
    while True:
        ...
        user_input = "Please remember new information about me if needed. Do not add old memory. If you remember anything, don't tell me what you just remember, just reply me." + user_input
